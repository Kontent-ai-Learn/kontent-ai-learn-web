                ...
                <div class="release-note"> 
                    <div class="release-note__info">   
                        ...
                        <div class="release-note__bar">
                            <time class="release-note__date" datetime="${dayjs.tz(item.release_date.value).format('YYYY-MM-DD')}"${getSmartLinkAttr(config, 'release_date', 'element')}>${isPlanned ? 'Planned for ' : ''}${dayjs.tz(item.release_date.value).format('MMMM D, YYYY')}</time>
